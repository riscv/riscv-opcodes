...
def create_priv_instr_dataset():
    ...
    return [
        ...
        (system_instr, 'Supervisor Memory-Management Instructions', ['sfence_vma'], False),
        (system_instr, 'Hypervisor Memory-Management Instructions', ['hfence_vvma', 'hfence_gvma'], False),
        (system_instr, 'Hypervisor Virtual-Machine Load and Store Instructions', 
            ['hlv_b', 'hlv_bu', 'hlv_h', 'hlv_hu', 'hlv_w', 'hlvx_hu', 'hlvx_wu', 'hsv_b', 'hsv_h', 'hsv_w'], False),
        (system_instr, 'Hypervisor Virtual-Machine Load and Store Instructions, RV64 only', ['hlv_wu', 'hlv_d', 'hsv_d'], False),
        (system_instr, 'Svinval Memory-Management Instructions', ['sinval_vma', 'sfence_w_inval', 'sfence_inval_ir', 'hinval_vvma', 'hinval_gvma'], False)
    ]
...
def get_table_configurations():
    ...
    return [
        ...
        create_table_configuration(
            ...
            datasets=[
                create_dataset(['64_i'], 'RV64I Base Instruction Set (in addition to RV32I)', [], False),
                create_dataset(['_zifencei'], 'RV32/RV64 Zifencei Standard Extension', [], False),
                create_dataset(['_zicsr'], 'RV32/RV64 Zicsr Standard Extension', [], False),
                create_dataset(['_m', '32_m'], 'RV32M Standard Extension', [], False),
                create_dataset(['64_m'], 'RV64M Standard Extension (in addition to RV32M)', [], False)
            ],
            word_size=32
        ),
        create_table_configuration(
            ...
            datasets=[
                ...
                create_dataset(['64_a'], 'RV64A Standard Extension (in addition to RV32A)', [], False)
            ],
            word_size=32
        ),
        create_table_configuration(
            ...
            datasets=[
                ...
                create_dataset(['64_f'], 'RV64F Standard Extension (in addition to RV32F)', [], False)
            ],
            word_size=32
        ),
        create_table_configuration(
            ...
            datasets=[
                ...
                create_dataset(['64_d'], 'RV64D Standard Extension (in addition to RV32D)', [], False)
            ],
            word_size=32
        ),
        create_table_configuration(
            ...
            datasets=[
                ...
                create_dataset(['64_q'], 'RV64Q Standard Extension (in addition to RV32Q)', [], False)
            ],
            word_size=32
        ),
        create_table_configuration(
            type_list=['R-type', 'R4-type', 'I-type', 'S-type'],
            datasets=[
                create_dataset(['_zfh', '_d_zfh', '_q_zfh'], 'RV32Zfh Standard Extension', [], False),
                create_dataset(['64_zfh'], 'RV64Zfh Standard Extension (in addition to RV32Zfh)', [], False)
            ],
            word_size=32,
        ...
        create_table_configuration(
            type_list=[''],
            datasets=[
                create_dataset(['_c', '32_c', '32_c_f', '_c_d'], 'RV32C Standard Extension', [], False),
                create_dataset(['64_c'], 'RV64C Standard Extension (in addition to RV32C)', [], False)
            ],
            word_size=16,
            caption=''
        )
...
def generate_instruction_entries(instr_dict, inst_list, ilen):
    ...
    for inst in inst_list:
        ...
        instr_entries += format_table_entry(fields, inst.upper().replace("_", "."), ilen)
