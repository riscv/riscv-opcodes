...
def make_go(instr_dict: InstrDict, extensions: list[str]):
    comment = """// Code generated with following arguments; DO NOT EDIT.
/*
make inst.go"""
    if extensions:
        comment += " EXTENSIONS='\\\n"
        ...
        comment += "'\n*/\n"
    comment += """// Package riscv encode RISC-V opcodes used by Go compiler
package riscv
